...
public class web : MonoBehaviour
{
    ...
    private void Awake()
    {
        oleadas = FindObjectOfType<ControlOleadas>();
    ...
    {
        UnityWebRequest web = UnityWebRequest.Get("https://pipasjourney.com/compartido/megahamsterleagueRanking.txt");
    ...
    private IEnumerator CorrutinaEscribir()
    {
        ...
        form.AddField("archivo", "megahamsterleagueRanking.txt");
    ...
    void CrearTabla()
    {
        for (int i = 0; i < cantidadRegistros; i++)
        {
            ...
            clon.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, i * -50);
    ...
    {
        if(oleadas.GetOleada()> datos.registros[cantidadRegistros-1].puntos)
        {
